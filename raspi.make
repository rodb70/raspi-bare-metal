...
qemu-main: 
	$(ARMGNU)-gcc -g -Wall -nostdlib -nostartfiles -ffreestanding -std=gnu99 -DQEMU=1 -c $(SOURCE)main.c -o $(BUILD)main.o
...
pitft-main:
	$(ARMGNU)-gcc -g -Wall -nostdlib -nostartfiles -ffreestanding -std=gnu99 -DPITFT=1 -c $(SOURCE)main.c -o $(BUILD)main.o

fb: OBJECTS = $(addprefix $(BUILD),bcm2835.o fb.o raycasting.o main.o)
fb: clean $(BUILD) fb-main all

fb-main:
	$(ARMGNU)-gcc -g -Wall -nostdlib -nostartfiles -ffreestanding -std=gnu99 -DFB=1 -c $(SOURCE)main.c -o $(BUILD)main.o
...
$(BUILD)%.o: $(SOURCE)%.c $(BUILD)
	$(ARMGNU)-gcc -g -Wall -nostdlib -nostartfiles -ffreestanding -std=gnu99 -c $< -o $@
