...
typedef enum
{
	BCM2835_GPIO_FSEL_INPT  = 0, // 0b000,   ///< Input
	BCM2835_GPIO_FSEL_OUTP  = 1, // 0b001,   ///< Output
	BCM2835_GPIO_FSEL_ALT0  = 4, // 0b100,   ///< Alternate function 0
	BCM2835_GPIO_FSEL_ALT1  = 5, // 0b101,   ///< Alternate function 1
	BCM2835_GPIO_FSEL_ALT2  = 6, // 0b110,   ///< Alternate function 2
	BCM2835_GPIO_FSEL_ALT3  = 7, // 0b111,   ///< Alternate function 3
	BCM2835_GPIO_FSEL_ALT4  = 3, // 0b011,   ///< Alternate function 4
	BCM2835_GPIO_FSEL_ALT5  = 2, // 0b010,   ///< Alternate function 5
	BCM2835_GPIO_FSEL_MASK  = 7, // 0b111    ///< Function select bits mask
...
typedef enum
{
	BCM2835_GPIO_PUD_OFF     = 0, // 0b00,   ///< Off ? disable pull-up/down
	BCM2835_GPIO_PUD_DOWN    = 1, // 0b01,   ///< Enable Pull Down control
	BCM2835_GPIO_PUD_UP      = 2, // 0b10    ///< Enable Pull Up control
} bcm2835PUDControl;
